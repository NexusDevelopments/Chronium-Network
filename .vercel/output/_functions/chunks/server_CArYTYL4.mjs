import { c as createInvalidVariablesError, g as getEnv$1, s as setOnSetGetEnv } from './runtime_CbHX_uPV.mjs';

const schema = {"API_URL":{"context":"server","access":"secret","optional":true,"default":"http://localhost:8080","type":"string"},"VERSION":{"context":"client","access":"public","optional":true,"default":"1.0.0","type":"string"},"MARKETPLACE_ENABLED":{"context":"client","access":"public","optional":true,"default":false,"type":"boolean"},"SEO":{"context":"client","access":"public","optional":true,"default":"{\"enabled\":false,\"domain\":\"chronium.network\"}","type":"string"}};
...
setOnSetGetEnv(() => {
	API_URL = _internalGetSecret("API_URL");

});
let API_URL = _internalGetSecret("API_URL");
